...
<div class="container2">
  ...
  <div class="dright">
    ...
    <form class="cinput" action="updateacademic.php?page=updateacademic" method="post">

      <div class="desf">
        <h1>Academic detail</h1>
      </div>
      <div class="indesc">
        <input type="text" class="input" placeholder="Enter academic name" name="Aname">
        <input type="text" class="input" placeholder="Enter academic code" name="Acode">
      </div>
