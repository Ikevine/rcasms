...
<div class="container">
    ...
    <form  action="createacademic.php?page=createacademic" method="post">

        <input type="text" placeholder="Code for enrolmentLevel" required name="Acode">
        <input type="text" placeholder="Enter enrol name" required name="Aname">
